...
(custom-set-faces
 ...
 '(region ((((class color) (min-colors 88) (background dark)) (:background "Green3" :foreground "black"))))
 ...
 '(w3m-tab-selected ((((type x w32 mac) (class color)) (:background "black" :foreground "LawnGreen" :box (:line-width -1 :color "#014500" :style released-button)))))
 ...
 '(w3m-tab-unselected ((((type x w32 mac) (class color)) (:background "black" :foreground "#10650F" :box (:line-width 1 :color "Black" :style pressed-button)))))
 '(w3m-tab-unselected-retrieving ((((type x w32 mac) (class color)) (:background "black" :foreground "grey30" :box (:line-width 1 :color "Black" :style pressed-button)))))
 '(w3m-tab-unselected-unseen ((((type x w32 mac) (class color)) (:background "black" :foreground "DodgerBlue" :box (:line-width 1 :color "black" :style pressed-button)))))
