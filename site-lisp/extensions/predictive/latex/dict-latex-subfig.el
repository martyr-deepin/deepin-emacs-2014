  ...
  (mapc
   (lambda (entry)
     (puthash
      ...
      ordered-hash))
   (dictree--ordered-hash dict-latex-subfig))
  (dictree--set-ordered-hash dict-latex-subfig ordered-hash))
(dictree--set-filename dict-latex-subfig (locate-library "dict-latex-subfig"))
(unless (memq dict-latex-subfig dictree-loaded-list) (push dict-latex-subfig dictree-loaded-list))
