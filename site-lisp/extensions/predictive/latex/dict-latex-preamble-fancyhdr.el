  ...
  (mapc
   (lambda (entry)
     (puthash
      ...
      ordered-hash))
   (dictree--ordered-hash dict-latex-preamble-fancyhdr))
  (dictree--set-ordered-hash dict-latex-preamble-fancyhdr ordered-hash))
(dictree--set-filename dict-latex-preamble-fancyhdr (locate-library "dict-latex-preamble-fancyhdr"))
(unless (memq dict-latex-preamble-fancyhdr dictree-loaded-list) (push dict-latex-preamble-fancyhdr dictree-loaded-list))
