  ...
  (mapc
   (lambda (entry)
     (puthash
      ...
      ordered-hash))
   (dictree--ordered-hash dict-latex-docclass))
  (dictree--set-ordered-hash dict-latex-docclass ordered-hash))
(dictree--set-filename dict-latex-docclass (locate-library "dict-latex-docclass"))
(unless (memq dict-latex-docclass dictree-loaded-list) (push dict-latex-docclass dictree-loaded-list))
