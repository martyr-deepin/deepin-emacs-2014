  ...
  (mapc
   (lambda (entry)
     (puthash
      ...
      ordered-hash))
   (dictree--ordered-hash dict-latex-graphicx))
  (dictree--set-ordered-hash dict-latex-graphicx ordered-hash))
(dictree--set-filename dict-latex-graphicx (locate-library "dict-latex-graphicx"))
(unless (memq dict-latex-graphicx dictree-loaded-list) (push dict-latex-graphicx dictree-loaded-list))
