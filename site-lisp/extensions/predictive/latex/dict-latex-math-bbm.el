  ...
  (mapc
   (lambda (entry)
     (puthash
      ...
      ordered-hash))
   (dictree--ordered-hash dict-latex-math-bbm))
  (dictree--set-ordered-hash dict-latex-math-bbm ordered-hash))
(dictree--set-filename dict-latex-math-bbm (locate-library "dict-latex-math-bbm"))
(unless (memq dict-latex-math-bbm dictree-loaded-list) (push dict-latex-math-bbm dictree-loaded-list))
