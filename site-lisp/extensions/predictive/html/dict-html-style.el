  ...
  (mapc
   (lambda (entry)
     (puthash
      ...
      ordered-hash))
   (dictree--ordered-hash dict-html-style))
  (dictree--set-ordered-hash dict-html-style ordered-hash))
(dictree--set-filename dict-html-style (locate-library "dict-html-style"))
(unless (memq dict-html-style dictree-loaded-list) (push dict-html-style dictree-loaded-list))
