  ...
  (mapc
   (lambda (entry)
     (puthash
      ...
      ordered-hash))
   (dictree--ordered-hash dict-html-quote))
  (dictree--set-ordered-hash dict-html-quote ordered-hash))
(dictree--set-filename dict-html-quote (locate-library "dict-html-quote"))
(unless (memq dict-html-quote dictree-loaded-list) (push dict-html-quote dictree-loaded-list))
