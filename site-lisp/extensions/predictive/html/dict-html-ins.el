  ...
  (mapc
   (lambda (entry)
     (puthash
      ...
      ordered-hash))
   (dictree--ordered-hash dict-html-ins))
  (dictree--set-ordered-hash dict-html-ins ordered-hash))
(dictree--set-filename dict-html-ins (locate-library "dict-html-ins"))
(unless (memq dict-html-ins dictree-loaded-list) (push dict-html-ins dictree-loaded-list))
