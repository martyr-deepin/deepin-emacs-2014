  ...
  (mapc
   (lambda (entry)
     (puthash
      ...
      ordered-hash))
   (dictree--ordered-hash dict-html-head))
  (dictree--set-ordered-hash dict-html-head ordered-hash))
(dictree--set-filename dict-html-head (locate-library "dict-html-head"))
(unless (memq dict-html-head dictree-loaded-list) (push dict-html-head dictree-loaded-list))
