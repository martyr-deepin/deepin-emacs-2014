  ...
  (mapc
   (lambda (entry)
     (puthash
      ...
      ordered-hash))
   (dictree--ordered-hash dict-html-international))
  (dictree--set-ordered-hash dict-html-international ordered-hash))
(dictree--set-filename dict-html-international (locate-library "dict-html-international"))
(unless (memq dict-html-international dictree-loaded-list) (push dict-html-international dictree-loaded-list))
