  ...
  (mapc
   (lambda (entry)
     (puthash
      ...
      ordered-hash))
   (dictree--ordered-hash dict-html-map))
  (dictree--set-ordered-hash dict-html-map ordered-hash))
(dictree--set-filename dict-html-map (locate-library "dict-html-map"))
(unless (memq dict-html-map dictree-loaded-list) (push dict-html-map dictree-loaded-list))
