  ...
  (mapc
   (lambda (entry)
     (puthash
      ...
      ordered-hash))
   (dictree--ordered-hash dict-html-legend))
  (dictree--set-ordered-hash dict-html-legend ordered-hash))
(dictree--set-filename dict-html-legend (locate-library "dict-html-legend"))
(unless (memq dict-html-legend dictree-loaded-list) (push dict-html-legend dictree-loaded-list))
