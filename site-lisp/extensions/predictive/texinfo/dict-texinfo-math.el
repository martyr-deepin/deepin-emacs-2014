  ...
  (mapc
   (lambda (entry)
     (puthash
      ...
      ordered-hash))
   (dictree--ordered-hash dict-texinfo-math))
  (dictree--set-ordered-hash dict-texinfo-math ordered-hash))
(dictree--set-filename dict-texinfo-math (locate-library "dict-texinfo-math"))
(unless (memq dict-texinfo-math dictree-loaded-list) (push dict-texinfo-math dictree-loaded-list))
